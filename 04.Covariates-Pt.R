...
#43. Split into seasons, add BirdID field----
...
data.vif <- data.season %>% 
  dplyr::select(grass.s, shrub.s, bare.s, crops.s, water.s, evi.s, waterdist.s, cropdist.s, cover.s, patch.s, alan.s, hmi.s, treedw.s, cropdw.s, waterdw.s)
cor(data.vif)
#grass and tree
vif(data.vif)
